...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PComment'
        db.create_table(u'comments_pcomment', (
            (u'comment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['comments.Comment'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'comments', ['PComment'])

        # Adding M2M table for field viewers on 'PComment'
        m2m_table_name = db.shorten_name(u'comments_pcomment_viewers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pcomment', models.ForeignKey(orm[u'comments.pcomment'], null=False)),
            ('chapter', models.ForeignKey(orm[u'chapters.chapter'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pcomment_id', 'chapter_id'])


    def backwards(self, orm):
        # Deleting model 'PComment'
        db.delete_table(u'comments_pcomment')

        # Removing M2M table for field viewers on 'PComment'
        db.delete_table(db.shorten_name(u'comments_pcomment_viewers'))
    ...
    models = {
        ...
        u'comments.pcomment': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'PComment', '_ormbases': [u'comments.Comment']},
