...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_user', 'phone', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'User.phone'
        db.alter_column(u'users_user', 'phone', self.gf('django.db.models.fields.BigIntegerField')(null=True))
