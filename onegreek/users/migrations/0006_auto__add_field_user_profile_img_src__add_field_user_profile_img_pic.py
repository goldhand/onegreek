...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.profile_img_src'
        db.add_column(u'users_user', 'profile_img_src',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'User.profile_img_pic'
        db.add_column(u'users_user', 'profile_img_pic',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.profile_img_src'
        db.delete_column(u'users_user', 'profile_img_src')

        # Deleting field 'User.profile_img_pic'
        db.delete_column(u'users_user', 'profile_img_pic')
