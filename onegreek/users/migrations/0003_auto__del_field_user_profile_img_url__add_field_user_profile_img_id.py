...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.profile_img_url'
        db.delete_column(u'users_user', 'profile_img_url')

        # Adding field 'User.profile_img_id'
        db.add_column(u'users_user', 'profile_img_id',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'User.profile_img_url'
        db.add_column(u'users_user', 'profile_img_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Deleting field 'User.profile_img_id'
        db.delete_column(u'users_user', 'profile_img_id')
    ...
    models = {
        ...
        u'users.user': {
            ...
            'profile_img_id': ('django.db.models.fields.URLField', [], {'max_length': '500', 'blank': 'True'}),
