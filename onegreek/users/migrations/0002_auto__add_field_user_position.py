...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_user', 'position',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chapters.Position'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.position'
        db.delete_column(u'users_user', 'position_id')
