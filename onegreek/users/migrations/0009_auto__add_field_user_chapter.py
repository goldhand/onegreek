...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.chapter'
        db.add_column(u'users_user', 'chapter',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chapters.Chapter'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field chapter on 'User'
        db.delete_table(db.shorten_name(u'users_user_chapter'))


    def backwards(self, orm):
        # Deleting field 'User.chapter'
        db.delete_column(u'users_user', 'chapter_id')

        # Adding M2M table for field chapter on 'User'
        m2m_table_name = db.shorten_name(u'users_user_chapter')
        ...
        db.create_unique(m2m_table_name, ['user_id', 'chapter_id'])
