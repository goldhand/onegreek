...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.profile_img_select'
        db.add_column(u'users_user', 'profile_img_select',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.profile_img_select'
        db.delete_column(u'users_user', 'profile_img_select')
    ...
    models = {
        ...
        u'users.user': {
            ...
            'profile_img_select': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
