...
from utils.email import split_addresses as split_choices
...
class FormForForm(forms.ModelForm):
    ...
    def __init__(self, form, *args, **kwargs):
        ...
        for field in self.form_fields:
            ...
            field_class = CLASSES[field.field_type]
            field_widget = WIDGETS.get(field.field_type)
            ...
            if "choices" in arg_names:
                ...
                #for choice in field_args["choices"]:
                #    choice.attrs["ng-model"] = '%s.field_%s.choice_%d' % ('rush_form', field_key, choice[0])
            ...
            if (field.required and FORMS_USE_HTML5 and
            ...
            if not field.field_type == CHECKBOX_MULTIPLE:
                self.fields[field_key].widget.attrs["ng-model"] = '%s.%s' % ('rush_form', field_key)
...
class EntriesForm(forms.Form):
    ...
    def __init__(self, form, request, *args, **kwargs):
        ...
        for field in self.form_fields:
            ...
            if field.is_a(*CHOICES):
                # A fixed set of choices to filter by.
                if field.is_a(CHECKBOX):
