...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Position.user'
        db.delete_column(u'chapters_position', 'user_id')


    def backwards(self, orm):
        # Adding field 'Position.user'
        db.add_column(u'chapters_position', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['users.User'], unique=True),
                      keep_default=False)
