...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chapter.gpa'
        db.alter_column(u'chapters_chapter', 'gpa', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2))

        # Changing field 'Chapter.cost'
        db.alter_column(u'chapters_chapter', 'cost', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Chapter.gpa'
        db.alter_column(u'chapters_chapter', 'gpa', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Chapter.cost'
        db.alter_column(u'chapters_chapter', 'cost', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'chapters.chapter': {
            ...
            'gpa': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '2', 'blank': 'True'}),
