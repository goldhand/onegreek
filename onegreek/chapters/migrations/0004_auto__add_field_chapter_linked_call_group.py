...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.linked_call_group'
        db.add_column(u'chapters_chapter', 'linked_call_group',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_call', unique=True, null=True, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.linked_call_group'
        db.delete_column(u'chapters_chapter', 'linked_call_group_id')
