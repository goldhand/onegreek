...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.linked_active_group'
        db.add_column(u'chapters_chapter', 'linked_active_group',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_active', unique=True, null=True, to=orm['auth.Group']),
                      keep_default=False)

        # Adding field 'Chapter.linked_admin_group'
        db.add_column(u'chapters_chapter', 'linked_admin_group',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_admin', unique=True, null=True, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.linked_active_group'
        db.delete_column(u'chapters_chapter', 'linked_active_group_id')

        # Deleting field 'Chapter.linked_admin_group'
        db.delete_column(u'chapters_chapter', 'linked_admin_group_id')
