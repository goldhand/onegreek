...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.fraternity_title'
        db.add_column(u'chapters_chapter', 'fraternity_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Chapter.university_title'
        db.add_column(u'chapters_chapter', 'university_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Chapter.linked_pending_group'
        db.add_column(u'chapters_chapter', 'linked_pending_group',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_pending', unique=True, null=True, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.fraternity_title'
        db.delete_column(u'chapters_chapter', 'fraternity_title')

        # Deleting field 'Chapter.university_title'
        db.delete_column(u'chapters_chapter', 'university_title')

        # Deleting field 'Chapter.linked_pending_group'
        db.delete_column(u'chapters_chapter', 'linked_pending_group_id')
