...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.location'
        db.add_column(u'chapters_chapter', 'location',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Chapter.linked_rush_group'
        db.add_column(u'chapters_chapter', 'linked_rush_group',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_rush', unique=True, null=True, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.location'
        db.delete_column(u'chapters_chapter', 'location')

        # Deleting field 'Chapter.linked_rush_group'
        db.delete_column(u'chapters_chapter', 'linked_rush_group_id')
