...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.rush_form'
        db.add_column(u'chapters_chapter', 'rush_form',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='chapter', unique=True, null=True, to=orm['rush_forms.Form']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.rush_form'
        db.delete_column(u'chapters_chapter', 'rush_form_id')
