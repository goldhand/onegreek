...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.fraternity'
        db.add_column(u'chapters_chapter', 'fraternity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fraternities.Fraternity'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.fraternity'
        db.delete_column(u'chapters_chapter', 'fraternity_id')
