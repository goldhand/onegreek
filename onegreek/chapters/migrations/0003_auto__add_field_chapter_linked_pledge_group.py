...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.linked_pledge_group'
        db.add_column(u'chapters_chapter', 'linked_pledge_group',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_pledge', unique=True, null=True, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.linked_pledge_group'
        db.delete_column(u'chapters_chapter', 'linked_pledge_group_id')
