...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'chapters_chapter', (
            ...
            ('linked_call_group', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_call', unique=True, null=True, to=orm['auth.Group'])),
            ('linked_pledge_group', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_pledge', unique=True, null=True, to=orm['auth.Group'])),
            ...
            ('linked_active_group', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_active', unique=True, null=True, to=orm['auth.Group'])),
            ('linked_admin_group', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='linked_chapter_admin', unique=True, null=True, to=orm['auth.Group'])),
            ('rush_form', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='chapter', unique=True, null=True, to=orm['rush_forms.Form'])),
