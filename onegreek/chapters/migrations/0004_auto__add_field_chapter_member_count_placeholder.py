...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.member_count_placeholder'
        db.add_column(u'chapters_chapter', 'member_count_placeholder',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.member_count_placeholder'
        db.delete_column(u'chapters_chapter', 'member_count_placeholder')
    ...
    models = {
        ...
        u'chapters.chapter': {
            ...
            'member_count_placeholder': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
