...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PermissionedComment'
        db.create_table(u'fluent_comments_permissionedcomment', (
            (u'comment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['comments.Comment'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'fluent_comments', ['PermissionedComment'])

        # Adding M2M table for field viewers on 'PermissionedComment'
        m2m_table_name = db.shorten_name(u'fluent_comments_permissionedcomment_viewers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('permissionedcomment', models.ForeignKey(orm[u'fluent_comments.permissionedcomment'], null=False)),
            ('chapter', models.ForeignKey(orm[u'chapters.chapter'], null=False))
        ))
        db.create_unique(m2m_table_name, ['permissionedcomment_id', 'chapter_id'])


    def backwards(self, orm):
        # Deleting model 'PermissionedComment'
        db.delete_table(u'fluent_comments_permissionedcomment')

        # Removing M2M table for field viewers on 'PermissionedComment'
        db.delete_table(db.shorten_name(u'fluent_comments_permissionedcomment_viewers'))
    ...
    models = {
        ...
        u'fluent_comments.permissionedcomment': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'PermissionedComment', '_ormbases': [u'comments.Comment']},
