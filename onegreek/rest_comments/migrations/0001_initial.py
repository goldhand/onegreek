...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RestComment'
        db.create_table(u'rest_comments_restcomment', (
        ...
        db.send_create_signal(u'rest_comments', ['RestComment'])


    def backwards(self, orm):
        # Deleting model 'RestComment'
        db.delete_table(u'rest_comments_restcomment')
