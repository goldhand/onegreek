...
from .views import EventDetail, EventList, EventCreate, EventCreateJSON
...
urlpatterns = patterns("events.views",
                       ...
                       url(r"^calendar/$", EventList.as_view(template_name='events/event_list_calendar.html'), name='list'),
