...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.chapter_id'
        db.add_column(u'events_event', 'chapter_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Event.chapter_title'
        db.add_column(u'events_event', 'chapter_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Event.fraternity_title'
        db.add_column(u'events_event', 'fraternity_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.chapter_id'
        db.delete_column(u'events_event', 'chapter_id')

        # Deleting field 'Event.chapter_title'
        db.delete_column(u'events_event', 'chapter_title')

        # Deleting field 'Event.fraternity_title'
        db.delete_column(u'events_event', 'fraternity_title')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'chapter_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'chapter_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
