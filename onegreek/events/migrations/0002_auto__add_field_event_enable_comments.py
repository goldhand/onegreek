...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.enable_comments'
        db.add_column(u'events_event', 'enable_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.enable_comments'
        db.delete_column(u'events_event', 'enable_comments')
